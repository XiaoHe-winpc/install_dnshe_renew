...
```bash
sudo bash -c "$(curl -fsSL https://github.com/XiaoHe-winpc/install_dnshe_renew/releases/download/2.0/install_dnshe_renew.sh)"
```
...
```bash
sudo bash -c "$(curl -fsSL https://github.com/XiaoHe-winpc/install_dnshe_renew/releases/download/2.0/install_dnshe_renew.sh)" _ "你的_API_Key" "你的_API_Secret"
```
